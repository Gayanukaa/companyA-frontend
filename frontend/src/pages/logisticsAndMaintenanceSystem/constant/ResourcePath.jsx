export const ResourcePath = {
  ...
  //ServiceMaintenance
  SERVICE_MAINTENANCE_API: "/SM1/service-maintenance",
  GET_ALL_SERVICE_MAINTENANCE: "",
  GET_SERVICE_MAINTENANCE_BY_ID: "",

  ADD_SERVICE_MAINTENANCE: "",
  UPDATE_SERVICE_MAINTENANCE: "/assignTechnician/",
  DELETE_SERVICE_MAINTENANCE: "/",
};
